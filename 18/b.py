...
with open("input.txt") as inp:
    import ast
    numbers = [ast.literal_eval(line) for line in inp]

max_magnitude = 0
for num1 in numbers:
    for num2 in numbers:
        if num1 is num2: continue
        snail1 = SnailfishNumber(num1, None)
        snail2 = SnailfishNumber(num2, None)
        snail1.add(snail2)
        max_magnitude = max(max_magnitude, snail1.magnitude())
